    ...
    <div className="space-y-8">
      ...
      {live.length === 0 && upcoming.length === 0 && (
        <div className="text-center py-20">
          ...
          <p className="text-zinc-400 font-medium">No hay eventos programados en este momento</p>
          <p className="text-zinc-600 text-sm mt-1">Los eventos se sincronizan automáticamente cada 30 minutos</p>
        </div>
      )}
